package com.yang.bill.widget.stickyheader;
...
public abstract class StickyHeaderGridAdapter extends RecyclerView.Adapter<StickyHeaderGridAdapter.ViewHolder> {
    ...
    * a header.
    * <p>
    * This new HeaderViewHolder should be constructed with a new ViewRendererRenderer that can represent the headers
    * of the given type. You can either create a new ViewRendererRenderer manually or inflate it from an XML
    * layout file.
    * <p>
    ...
    * the ViewRendererRenderer to avoid unnecessary {@link View#findViewById(int)} calls.
    *
    * @param parent The ViewGroup into which the new ViewRendererRenderer will be added after it is bound to
    *               an adapter position.
    * @param headerType The view type of the new ViewRendererRenderer.
    *
    * @return A new ViewHolder that holds a ViewRendererRenderer of the given view type.
    ...
    * an item.
    * <p>
    * This new ViewHolder should be constructed with a new ViewRendererRenderer that can represent the items
    * of the given type. You can either create a new ViewRendererRenderer manually or inflate it from an XML
    * layout file.
    * <p>
    ...
    * @param parent The ViewGroup into which the new ViewRendererRenderer will be added after it is bound to
    *               an adapter position.
    * @param itemType The view type of the new ViewRendererRenderer.
    *
    * @return A new ViewHolder that holds a ViewRendererRenderer of the given view type.
